    ...
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(CourseEditInputModel inputModel)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Spiacenti, il salvataggio non è andato a buon fine perché nel frattempo un altro utente ha aggionato il corso. Ti preghiamo di aggiornare la pagina e ripetere le modifiche.");
                }
            }
